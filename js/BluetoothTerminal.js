...
class BluetoothTerminal {
    ...
    constructor(
        ...
        this._boundHandleCharacteristicValueChanged = this._handleCharacteristicValueChanged.bind(
            this
        );
    ...
    send(data) {
        ...
        let chunks = this.constructor._splitByLength(
            data,
